...
if __name__ == "__main__":
    ...
    cap = cv2.VideoCapture("/home/ml/code/keras/yolo_tiny/traffic.mp4")
    while True:
        ...
        for box in boxes:            
            ...
            if CLASSES[box.get_label()] == "person" and not already:
                already = True
                cv2.putText(im_out, str("freia!!!"), (im_w/3, im_h/2), cv2.FONT_HERSHEY_PLAIN, 10, (0, 0, 0), 6)
                cv2.putText(im_out, str("freia!!!"), (im_w/3, im_h/2), cv2.FONT_HERSHEY_PLAIN, 10, (255, 255, 255), 2)
